/* app-muted.js — variant of app.js for the muted landing test.
...
/* ---- background: muted Water Lilies — reflective color wash, NO lily pads ---- */
(function () {
  ...
  var vel = { x: 0, y: 0 };
  var lastFB = null;
  var SEED = [Math.random() * 60.0, Math.random() * 60.0];   // new reflection field each reload
  ...
  (function () {
    ...
    var blooms = [];
    var fxRunning = false;
    var PETALS = [[238, 215, 220], [220, 212, 231], [245, 233, 216]];
